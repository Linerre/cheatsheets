...
\tikzset{
  ...
  % LR DFA state
  lrst/.style={draw,shape=rectangle,minimum width=22mm,inner sep=2pt, font=\small,align=left},
  % Stack frame or AR
  ar/.style={draw,shape=rectangle,minimum width=32mm,font=\footnotesize\ttfamily},
